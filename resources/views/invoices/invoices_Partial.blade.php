...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('invoices.title') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('invoices.title_partial') }}
                </span>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $invoice->Total }}</td>
                                        <td>
                                            <x-status-badge :status="$invoice->Value_Status" />
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                        href=" {{ url('edit_invoice') }}/{{ $invoice->id }}">{{ __('invoices.edit_invoice') }}</a>
